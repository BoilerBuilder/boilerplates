module.exports = {
  ...
  collectCoverageFrom: [
    'src/**/*.{js,jsx,ts,tsx}', // Indica quais arquivos devem ser considerados para a cobertura de código, excluindo alguns específicos.
    '!src/index.js,ts,tsx',
    '!src/**/*.test.js,ts,tsx',
    '!src/**/index.js,ts,tsx',
  ],
  coverageDirectory: 'coverage', // Especifica o diretório onde os relatórios de cobertura serão gerados.
  moduleFileExtensions: ['js', 'json', 'jsx', 'ts', 'tsx'], // Define as extensões de arquivo a serem tratadas como módulos.
  moduleNameMapper: {
  ...
  testMatch: ['**/?(*.)+(spec|test).{js,jsx,ts,tsx}'], // Padrões de nome de arquivo para identificar arquivos de teste.
